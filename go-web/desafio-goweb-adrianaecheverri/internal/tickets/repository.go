...
import (
	"context"
	"fmt"
	"github.com/aecheverriro/backpack-bcgow6-adriana-echeverri/go-web/desafio-go-web-adrianaecheverri/internal/domain"
)
...
func (r *repository) AmountTicketsByDestination(ctx context.Context, destination string) (int, error){
	var amount int
